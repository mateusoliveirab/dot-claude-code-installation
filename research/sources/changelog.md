...
[Getting started](https://code.claude.com/docs/en/changelog/docs/en/overview)[Build with Claude Code](https://code.claude.com/docs/en/changelog/docs/en/sub-agents)[Deployment](https://code.claude.com/docs/en/changelog/docs/en/third-party-integrations)[Administration](https://code.claude.com/docs/en/changelog/docs/en/setup)[Configuration](https://code.claude.com/docs/en/changelog/docs/en/settings)[Reference](https://code.claude.com/docs/en/changelog/docs/en/cli-reference)[Resources](https://code.claude.com/docs/en/changelog/docs/en/legal-and-compliance)

##### Getting started

* [Overview](https://code.claude.com/docs/en/changelog/docs/en/overview)
* [Quickstart](https://code.claude.com/docs/en/changelog/docs/en/quickstart)
* [Changelog](https://code.claude.com/docs/en/changelog/docs/en/changelog)

##### Core concepts

* [How Claude Code works](https://code.claude.com/docs/en/changelog/docs/en/how-claude-code-works)
* [Extend Claude Code](https://code.claude.com/docs/en/changelog/docs/en/features-overview)
* [Store instructions and memories](https://code.claude.com/docs/en/changelog/docs/en/memory)
* [Common workflows](https://code.claude.com/docs/en/changelog/docs/en/common-workflows)
* [Best practices](https://code.claude.com/docs/en/changelog/docs/en/best-practices)

##### Platforms and integrations

* [Remote Control](https://code.claude.com/docs/en/changelog/docs/en/remote-control)
* [Claude Code on the web](https://code.claude.com/docs/en/changelog/docs/en/claude-code-on-the-web)
* Claude Code on desktop
* [Chrome extension (beta)](https://code.claude.com/docs/en/changelog/docs/en/chrome)
* [Visual Studio Code](https://code.claude.com/docs/en/changelog/docs/en/vs-code)
* [JetBrains IDEs](https://code.claude.com/docs/en/changelog/docs/en/jetbrains)
* Code review & CI/CD
* [Claude Code in Slack](https://code.claude.com/docs/en/changelog/docs/en/slack)
...
[Quickstart](https://code.claude.com/docs/en/changelog/docs/en/quickstart)[How Claude Code works](https://code.claude.com/docs/en/changelog/docs/en/how-claude-code-works)
