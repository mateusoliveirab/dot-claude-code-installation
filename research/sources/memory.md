...
[Getting started](https://code.claude.com/docs/en/memory/docs/en/overview)[Build with Claude Code](https://code.claude.com/docs/en/memory/docs/en/sub-agents)[Deployment](https://code.claude.com/docs/en/memory/docs/en/third-party-integrations)[Administration](https://code.claude.com/docs/en/memory/docs/en/setup)[Configuration](https://code.claude.com/docs/en/memory/docs/en/settings)[Reference](https://code.claude.com/docs/en/memory/docs/en/cli-reference)[Resources](https://code.claude.com/docs/en/memory/docs/en/legal-and-compliance)

##### Getting started

* [Overview](https://code.claude.com/docs/en/memory/docs/en/overview)
* [Quickstart](https://code.claude.com/docs/en/memory/docs/en/quickstart)
* [Changelog](https://code.claude.com/docs/en/memory/docs/en/changelog)

##### Core concepts

* [How Claude Code works](https://code.claude.com/docs/en/memory/docs/en/how-claude-code-works)
* [Extend Claude Code](https://code.claude.com/docs/en/memory/docs/en/features-overview)
* [Store instructions and memories](https://code.claude.com/docs/en/memory/docs/en/memory)
* [Common workflows](https://code.claude.com/docs/en/memory/docs/en/common-workflows)
* [Best practices](https://code.claude.com/docs/en/memory/docs/en/best-practices)

##### Platforms and integrations

* [Remote Control](https://code.claude.com/docs/en/memory/docs/en/remote-control)
* [Claude Code on the web](https://code.claude.com/docs/en/memory/docs/en/claude-code-on-the-web)
* Claude Code on desktop
* [Chrome extension (beta)](https://code.claude.com/docs/en/memory/docs/en/chrome)
* [Visual Studio Code](https://code.claude.com/docs/en/memory/docs/en/vs-code)
* [JetBrains IDEs](https://code.claude.com/docs/en/memory/docs/en/jetbrains)
* Code review & CI/CD
* [Claude Code in Slack](https://code.claude.com/docs/en/memory/docs/en/slack)
...
Use CLAUDE.md files when you want to guide Claude’s behavior. Auto memory lets Claude learn from your corrections without manual effort. Subagents can also maintain their own auto memory. See [subagent configuration](https://code.claude.com/docs/en/memory/docs/en/sub-agents#enable-persistent-memory) for details. 
...
Rules load into context every session or when matching files are opened. For task-specific instructions that don’t need to be in context all the time, use [skills](https://code.claude.com/docs/en/memory/docs/en/skills) instead, which only load when you invoke them or when Claude determines they’re relevant to your prompt.
...
Use MDM, Group Policy, Ansible, or similar tools to distribute the file across developer machines. See [managed settings](https://code.claude.com/docs/en/memory/docs/en/permissions#managed-settings) for other organization-wide configuration options.
...
Patterns are matched against absolute file paths using glob syntax. You can configure `claudeMdExcludes` at any [settings layer](https://code.claude.com/docs/en/memory/docs/en/settings#settings-files): user, project, local, or managed policy. Arrays merge across layers. Managed policy CLAUDE.md files cannot be excluded. This ensures organization-wide instructions always apply regardless of individual settings. 
...
For instructions you want at the system prompt level, use [\--append-system-prompt](https://code.claude.com/docs/en/memory/docs/en/cli-reference#system-prompt-flags). This must be passed every invocation, so it’s better suited to scripts and automation than interactive use. 

Use the [InstructionsLoaded hook](https://code.claude.com/docs/en/memory/docs/en/hooks#instructionsloaded) to log exactly which instruction files are loaded, when they load, and why. This is useful for debugging path-specific rules or lazy-loaded files in subdirectories.
...
* [Skills](https://code.claude.com/docs/en/memory/docs/en/skills): package repeatable workflows that load on demand
* [Settings](https://code.claude.com/docs/en/memory/docs/en/settings): configure Claude Code behavior with settings files
* [Manage sessions](https://code.claude.com/docs/en/memory/docs/en/sessions): manage context, resume conversations, and run parallel sessions
* [Subagent memory](https://code.claude.com/docs/en/memory/docs/en/sub-agents#enable-persistent-memory): let subagents maintain their own auto memory

Was this page helpful?

YesNo

[Extend Claude Code](https://code.claude.com/docs/en/memory/docs/en/features-overview)[Common workflows](https://code.claude.com/docs/en/memory/docs/en/common-workflows)
