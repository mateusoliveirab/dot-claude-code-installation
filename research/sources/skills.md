...
[Getting started](https://code.claude.com/docs/en/skills/docs/en/overview)[Build with Claude Code](https://code.claude.com/docs/en/skills/docs/en/sub-agents)[Deployment](https://code.claude.com/docs/en/skills/docs/en/third-party-integrations)[Administration](https://code.claude.com/docs/en/skills/docs/en/setup)[Configuration](https://code.claude.com/docs/en/skills/docs/en/settings)[Reference](https://code.claude.com/docs/en/skills/docs/en/cli-reference)[Resources](https://code.claude.com/docs/en/skills/docs/en/legal-and-compliance)

##### Build with Claude Code

* [Create custom subagents](https://code.claude.com/docs/en/skills/docs/en/sub-agents)
* [Run agent teams](https://code.claude.com/docs/en/skills/docs/en/agent-teams)
* [Create plugins](https://code.claude.com/docs/en/skills/docs/en/plugins)
* [Discover and install prebuilt plugins](https://code.claude.com/docs/en/skills/docs/en/discover-plugins)
* [Extend Claude with skills](https://code.claude.com/docs/en/skills/docs/en/skills)
* [Run prompts on a schedule](https://code.claude.com/docs/en/skills/docs/en/scheduled-tasks)
* [Output styles](https://code.claude.com/docs/en/skills/docs/en/output-styles)
* [Automate with hooks](https://code.claude.com/docs/en/skills/docs/en/hooks-guide)
* [Programmatic usage](https://code.claude.com/docs/en/skills/docs/en/headless)
* [Model Context Protocol (MCP)](https://code.claude.com/docs/en/skills/docs/en/mcp)
* [Troubleshooting](https://code.claude.com/docs/en/skills/docs/en/troubleshooting)
...
For built-in commands like `/help` and `/compact`, see the [built-in commands reference](https://code.claude.com/docs/en/skills/docs/en/commands).**Custom commands have been merged into skills.** A file at `.claude/commands/deploy.md` and a skill at `.claude/skills/deploy/SKILL.md` both create `/deploy` and work the same way. Your existing `.claude/commands/` files keep working. Skills add optional features: a directory for supporting files, frontmatter to [control whether you or Claude invokes them](#control-who-invokes-a-skill), and the ability for Claude to load them automatically when relevant.
...
Bundled skills ship with Claude Code and are available in every session. Unlike [built-in commands](https://code.claude.com/docs/en/skills/docs/en/commands), which execute fixed logic directly, bundled skills are prompt-based: they give Claude a detailed playbook and let it orchestrate the work using its tools. This means bundled skills can spawn parallel agents, read files, and adapt to your codebase. You invoke bundled skills the same way as any other skill: type `/` followed by the skill name. In the table below, `<arg>` indicates a required argument and `[arg]` indicates an optional one. 

| Skill                       | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| /batch <instruction>        | Orchestrate large-scale changes across a codebase in parallel. Researches the codebase, decomposes the work into 5 to 30 independent units, and presents a plan. Once approved, spawns one background agent per unit in an isolated [git worktree](https://code.claude.com/docs/en/skills/docs/en/common-workflows#run-parallel-claude-code-sessions-with-git-worktrees). Each agent implements its unit, runs tests, and opens a pull request. Requires a git repository. Example: /batch migrate src/ from Solid to React |
| /claude-api                 | Load Claude API reference material for your project’s language (Python, TypeScript, Java, Go, Ruby, C#, PHP, or cURL) and Agent SDK reference for Python and TypeScript. Covers tool use, streaming, batches, structured outputs, and common pitfalls. Also activates automatically when your code imports anthropic, @anthropic-ai/sdk, or claude\_agent\_sdk                                                                                                                        |
...
| ---------- | -------------------------------------------------------- | ------------------------------ |
| Enterprise | See [managed settings](https://code.claude.com/docs/en/skills/docs/en/settings#settings-files) | All users in your organization |
...
CLAUDE.md files from `--add-dir` directories are not loaded by default. To load them, set `CLAUDE_CODE_ADDITIONAL_DIRECTORIES_CLAUDE_MD=1`. See [Load from additional directories](https://code.claude.com/docs/en/skills/docs/en/memory#load-from-additional-directories).
...
| hooks                    | No          | Hooks scoped to this skill’s lifecycle. See [Hooks in skills and agents](https://code.claude.com/docs/en/skills/docs/en/hooks#hooks-in-skills-and-agents) for configuration format.         |
...
To enable [extended thinking](https://code.claude.com/docs/en/skills/docs/en/common-workflows#use-extended-thinking-thinking-mode) in a skill, include the word “ultrathink” anywhere in your skill content.
...
Skills and [subagents](https://code.claude.com/docs/en/skills/docs/en/sub-agents) work together in two directions: 
...
With `context: fork`, you write the task in your skill and pick an agent type to execute it. For the inverse (defining a custom subagent that uses skills as reference material), see [Subagents](https://code.claude.com/docs/en/skills/docs/en/sub-agents#preload-skills-into-subagents). 
...
**Allow or deny specific skills** using [permission rules](https://code.claude.com/docs/en/skills/docs/en/permissions): 
...
* **Plugins**: Create a `skills/` directory in your [plugin](https://code.claude.com/docs/en/skills/docs/en/plugins)
* **Managed**: Deploy organization-wide through [managed settings](https://code.claude.com/docs/en/skills/docs/en/settings#settings-files)
...
* **[Subagents](https://code.claude.com/docs/en/skills/docs/en/sub-agents)**: delegate tasks to specialized agents
* **[Plugins](https://code.claude.com/docs/en/skills/docs/en/plugins)**: package and distribute skills with other extensions
* **[Hooks](https://code.claude.com/docs/en/skills/docs/en/hooks)**: automate workflows around tool events
* **[Memory](https://code.claude.com/docs/en/skills/docs/en/memory)**: manage CLAUDE.md files for persistent context
* **[Built-in commands](https://code.claude.com/docs/en/skills/docs/en/commands)**: reference for built-in `/` commands
* **[Permissions](https://code.claude.com/docs/en/skills/docs/en/permissions)**: control tool and skill access

Was this page helpful?

YesNo

[Discover and install prebuilt plugins](https://code.claude.com/docs/en/skills/docs/en/discover-plugins)[Run prompts on a schedule](https://code.claude.com/docs/en/skills/docs/en/scheduled-tasks)
