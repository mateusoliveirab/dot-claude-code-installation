...
[Getting started](https://code.claude.com/docs/en/plugins-reference/docs/en/overview)[Build with Claude Code](https://code.claude.com/docs/en/plugins-reference/docs/en/sub-agents)[Deployment](https://code.claude.com/docs/en/plugins-reference/docs/en/third-party-integrations)[Administration](https://code.claude.com/docs/en/plugins-reference/docs/en/setup)[Configuration](https://code.claude.com/docs/en/plugins-reference/docs/en/settings)[Reference](https://code.claude.com/docs/en/plugins-reference/docs/en/cli-reference)[Resources](https://code.claude.com/docs/en/plugins-reference/docs/en/legal-and-compliance)

##### Reference

* [CLI reference](https://code.claude.com/docs/en/plugins-reference/docs/en/cli-reference)
* [Built-in commands](https://code.claude.com/docs/en/plugins-reference/docs/en/commands)
* [Environment variables](https://code.claude.com/docs/en/plugins-reference/docs/en/env-vars)
* [Tools reference](https://code.claude.com/docs/en/plugins-reference/docs/en/tools-reference)
* [Interactive mode](https://code.claude.com/docs/en/plugins-reference/docs/en/interactive-mode)
* [Checkpointing](https://code.claude.com/docs/en/plugins-reference/docs/en/checkpointing)
* [Hooks reference](https://code.claude.com/docs/en/plugins-reference/docs/en/hooks)
* [Plugins reference](https://code.claude.com/docs/en/plugins-reference/docs/en/plugins-reference)
...
Looking to install plugins? See [Discover and install plugins](https://code.claude.com/docs/en/plugins-reference/docs/en/discover-plugins). For creating plugins, see [Plugins](https://code.claude.com/docs/en/plugins-reference/docs/en/plugins). For distributing plugins, see [Plugin marketplaces](https://code.claude.com/docs/en/plugins-reference/docs/en/plugin-marketplaces).
...
For complete details, see [Skills](https://code.claude.com/docs/en/plugins-reference/docs/en/skills). 
...
For complete details, see [Subagents](https://code.claude.com/docs/en/plugins-reference/docs/en/sub-agents). 
...
| managed | [Managed settings](https://code.claude.com/docs/en/plugins-reference/docs/en/settings#settings-files) | Managed plugins (read-only, update only)                 |

Plugins use the same scope system as other Claude Code configurations. For installation instructions and scope flags, see [Install plugins](https://code.claude.com/docs/en/plugins-reference/docs/en/discover-plugins#install-plugins). For a complete explanation of scopes, see [Configuration scopes](https://code.claude.com/docs/en/plugins-reference/docs/en/settings#configuration-scopes). 
...
| **Settings**    | settings.json              | Default configuration applied when the plugin is enabled. Only [agent](https://code.claude.com/docs/en/plugins-reference/docs/en/sub-agents) settings are currently supported |
...
* [Plugins](https://code.claude.com/docs/en/plugins-reference/docs/en/plugins) \- Tutorials and practical usage
* [Plugin marketplaces](https://code.claude.com/docs/en/plugins-reference/docs/en/plugin-marketplaces) \- Creating and managing marketplaces
* [Skills](https://code.claude.com/docs/en/plugins-reference/docs/en/skills) \- Skill development details
* [Subagents](https://code.claude.com/docs/en/plugins-reference/docs/en/sub-agents) \- Agent configuration and capabilities
* [Hooks](https://code.claude.com/docs/en/plugins-reference/docs/en/hooks) \- Event handling and automation
* [MCP](https://code.claude.com/docs/en/plugins-reference/docs/en/mcp) \- External tool integration
* [Settings](https://code.claude.com/docs/en/plugins-reference/docs/en/settings) \- Configuration options for plugins
