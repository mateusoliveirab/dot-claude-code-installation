...
[Getting started](https://code.claude.com/docs/en/settings/docs/en/overview)[Build with Claude Code](https://code.claude.com/docs/en/settings/docs/en/sub-agents)[Deployment](https://code.claude.com/docs/en/settings/docs/en/third-party-integrations)[Administration](https://code.claude.com/docs/en/settings/docs/en/setup)[Configuration](https://code.claude.com/docs/en/settings/docs/en/settings)[Reference](https://code.claude.com/docs/en/settings/docs/en/cli-reference)[Resources](https://code.claude.com/docs/en/settings/docs/en/legal-and-compliance)

##### Configuration

* [Settings](https://code.claude.com/docs/en/settings/docs/en/settings)
* [Permissions](https://code.claude.com/docs/en/settings/docs/en/permissions)
* [Sandboxing](https://code.claude.com/docs/en/settings/docs/en/sandboxing)
* [Terminal configuration](https://code.claude.com/docs/en/settings/docs/en/terminal-config)
* [Model configuration](https://code.claude.com/docs/en/settings/docs/en/model-config)
* [Speed up responses with fast mode](https://code.claude.com/docs/en/settings/docs/en/fast-mode)
* [Customize status line](https://code.claude.com/docs/en/settings/docs/en/statusline)
* [Customize keyboard shortcuts](https://code.claude.com/docs/en/settings/docs/en/keybindings)
...
* **Managed settings**: For organizations that need centralized control, Claude Code supports multiple delivery mechanisms for managed settings. All use the same JSON format and cannot be overridden by user or project settings:  
   * **Server-managed settings**: delivered from Anthropic’s servers via the Claude.ai admin console. See [server-managed settings](https://code.claude.com/docs/en/settings/docs/en/server-managed-settings).  
...
See [managed settings](https://code.claude.com/docs/en/settings/docs/en/permissions#managed-only-settings) and [Managed MCP configuration](https://code.claude.com/docs/en/settings/docs/en/mcp#managed-mcp-configuration) for details.  
Managed deployments can also restrict **plugin marketplace additions** using`strictKnownMarketplaces`. For more information, see [Managed marketplace restrictions](https://code.claude.com/docs/en/settings/docs/en/plugin-marketplaces#managed-marketplace-restrictions).
* **Other configuration** is stored in `~/.claude.json`. This file contains your preferences (theme, notification settings, editor mode), OAuth session, [MCP server](https://code.claude.com/docs/en/settings/docs/en/mcp) configurations for user and local scopes, per-project state (allowed tools, trust settings), and various caches. Project-scoped MCP servers are stored separately in `.mcp.json`.
...
| hooks                           | Configure custom commands to run at lifecycle events. See [hooks documentation](https://code.claude.com/docs/en/settings/docs/en/hooks) for format                                                                                                                                                                                                    | See [hooks](https://code.claude.com/docs/en/settings/docs/en/hooks)                                             |
| disableAllHooks                 | Disable all [hooks](https://code.claude.com/docs/en/settings/docs/en/hooks) and any custom [status line](https://code.claude.com/docs/en/settings/docs/en/statusline)                                                                                                                                                                                                                         | true                                                                    |
...
| allowManagedPermissionRulesOnly | (Managed settings only) Prevent user and project settings from defining allow, ask, or deny permission rules. Only rules in managed settings apply. See [Managed-only settings](https://code.claude.com/docs/en/settings/docs/en/permissions#managed-only-settings)                                                                                   | true                                                                    |
| allowManagedMcpServersOnly      | (Managed settings only) Only allowedMcpServers from managed settings are respected. deniedMcpServers still merges from all sources. Users can still add MCP servers, but only the admin-defined allowlist applies. See [Managed MCP configuration](https://code.claude.com/docs/en/settings/docs/en/mcp#managed-mcp-configuration)                    | true                                                                    |
| model                           | Override the default model to use for Claude Code                                                                                                                                                                                                                                                             | "claude-sonnet-4-6"                                                     |
| availableModels                 | Restrict which models users can select via /model, \--model, Config tool, or ANTHROPIC\_MODEL. Does not affect the Default option. See [Restrict model selection](https://code.claude.com/docs/en/settings/docs/en/model-config#restrict-model-selection)                                                                                             | \["sonnet", "haiku"\]                                                   |
| modelOverrides                  | Map Anthropic model IDs to provider-specific model IDs such as Bedrock inference profile ARNs. Each model picker entry uses its mapped value when calling the provider API. See [Override model IDs per version](https://code.claude.com/docs/en/settings/docs/en/model-config#override-model-ids-per-version)                                        | {"claude-opus-4-6": "arn:aws:bedrock:..."}                              |
| effortLevel                     | Persist the [effort level](https://code.claude.com/docs/en/settings/docs/en/model-config#adjust-effort-level) across sessions. Accepts "low", "medium", or "high". Written automatically when you run /effort low, /effort medium, or /effort high. Supported on Opus 4.6 and Sonnet 4.6                                                              | "medium"                                                                |
| otelHeadersHelper               | Script to generate dynamic OpenTelemetry headers. Runs at startup and periodically (see [Dynamic headers](https://code.claude.com/docs/en/settings/docs/en/monitoring-usage#dynamic-headers))                                                                                                                                                         | /bin/generate\_otel\_headers.sh                                         |
| statusLine                      | Configure a custom status line to display context. See [statusLine documentation](https://code.claude.com/docs/en/settings/docs/en/statusline)                                                                                                                                                                                                        | {"type": "command", "command": "\~/.claude/statusline.sh"}              |
...
| outputStyle                     | Configure an output style to adjust the system prompt. See [output styles documentation](https://code.claude.com/docs/en/settings/docs/en/output-styles)                                                                                                                                                                                              | "Explanatory"                                                           |
...
| awsAuthRefresh                  | Custom script that modifies the .aws directory (see [advanced credential configuration](https://code.claude.com/docs/en/settings/docs/en/amazon-bedrock#advanced-credential-configuration))                                                                                                                                                           | aws sso login --profile myprofile                                       |
| awsCredentialExport             | Custom script that outputs JSON with AWS credentials (see [advanced credential configuration](https://code.claude.com/docs/en/settings/docs/en/amazon-bedrock#advanced-credential-configuration))                                                                                                                                                     | /bin/generate\_aws\_grant.sh                                            |
| alwaysThinkingEnabled           | Enable [extended thinking](https://code.claude.com/docs/en/settings/docs/en/common-workflows#use-extended-thinking-thinking-mode) by default for all sessions. Typically configured via the /config command rather than editing directly                                                                                                              | true                                                                    |
...
| fastModePerSessionOptIn         | When true, fast mode does not persist across sessions. Each session starts with fast mode off, requiring users to enable it with /fast. The user’s fast mode preference is still saved. See [Require per-session opt-in](https://code.claude.com/docs/en/settings/docs/en/fast-mode#require-per-session-opt-in)                                       | true                                                                    |
| teammateMode                    | How [agent team](https://code.claude.com/docs/en/settings/docs/en/agent-teams) teammates display: auto (picks split panes in tmux or iTerm2, in-process otherwise), in-process, or tmux. See [set up agent teams](https://code.claude.com/docs/en/settings/docs/en/agent-teams#set-up-agent-teams)                                                                                            | "in-process"                                                            |
...
| deny                         | Array of permission rules to deny tool use. Use this to exclude sensitive files from Claude Code access. See [Permission rule syntax](#permission-rule-syntax) and [Bash permission limitations](https://code.claude.com/docs/en/settings/docs/en/permissions#tool-specific-permission-rules) | \[ "WebFetch", "Bash(curl \*)", "Read(./.env)", "Read(./secrets/\*\*)" \] |
| additionalDirectories        | Additional [working directories](https://code.claude.com/docs/en/settings/docs/en/permissions#working-directories) that Claude has access to                                                                                                                                                  | \[ "../docs/" \]                                                          |
| defaultMode                  | Default [permission mode](https://code.claude.com/docs/en/settings/docs/en/permissions#permission-modes) when opening Claude Code                                                                                                                                                             | "acceptEdits"                                                             |
| disableBypassPermissionsMode | Set to "disable" to prevent bypassPermissions mode from being activated. This disables the \--dangerously-skip-permissions command-line flag. See [managed settings](https://code.claude.com/docs/en/settings/docs/en/permissions#managed-only-settings)                                      | "disable"                                                                 |
...
For the complete rule syntax reference, including wildcard behavior, tool-specific patterns for Read, Edit, WebFetch, MCP, and Agent rules, and security limitations of Bash patterns, see [Permission rule syntax](https://code.claude.com/docs/en/settings/docs/en/permissions#permission-rule-syntax). 
...
Configure advanced sandboxing behavior. Sandboxing isolates bash commands from your filesystem and network. See [Sandboxing](https://code.claude.com/docs/en/settings/docs/en/sandboxing) for details. 
...
| /               | Relative to the settings file’s directory   | /build becomes $SETTINGS\_DIR/build |
...
The command runs with the same environment variables as [hooks](https://code.claude.com/docs/en/settings/docs/en/hooks), including `CLAUDE_PROJECT_DIR`. It receives JSON via stdin with a `query` field: 
...
1. **Managed settings** ([server-managed](https://code.claude.com/docs/en/settings/docs/en/server-managed-settings), [MDM/OS-level policies](#configuration-scopes), or [managed settings](https://code.claude.com/docs/en/settings/docs/en/settings#settings-files))  
...
Subagent files define specialized AI assistants with custom prompts and tool permissions. Learn more about creating and using subagents in the [subagents documentation](https://code.claude.com/docs/en/settings/docs/en/sub-agents). 
...
**Managed settings only**: Controls which plugin marketplaces users are allowed to add. This setting can only be configured in [managed settings](https://code.claude.com/docs/en/settings/docs/en/settings#settings-files) and provides administrators with strict control over marketplace sources. **Managed settings file locations**: 
...
See [Managed marketplace restrictions](https://code.claude.com/docs/en/settings/docs/en/plugin-marketplaces#managed-marketplace-restrictions) for user-facing documentation. 
...
Learn more about the plugin system in the [plugins documentation](https://code.claude.com/docs/en/settings/docs/en/plugins). 
...
* [Permissions](https://code.claude.com/docs/en/settings/docs/en/permissions): permission system, rule syntax, tool-specific patterns, and managed policies
* [Authentication](https://code.claude.com/docs/en/settings/docs/en/authentication): set up user access to Claude Code
* [Troubleshooting](https://code.claude.com/docs/en/settings/docs/en/troubleshooting): solutions for common configuration issues
